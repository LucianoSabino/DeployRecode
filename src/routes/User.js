...
const historicoController = require("../controllers/perguntas/Perguntas");
//Fim Importações
...
); //Devolve as Informações do perfil do User Atual
router.post(
  "/user/profile/changepassword",
  authorization.auth,
  userVerify.userVerify,
  userProfileController.trocarSenha
); //Troca a senha doo Usuario
router.post(
  "/user/profile/changeprofile",
  authorization.auth,
  userVerify.userVerify,
  userProfileController.modificarPerfil
); //Modifica o Perfil do User

//Rotas de Register
router.post(
  "/register/createinstituition",
  registerController.createInstituition
...
router.get(
  ...
  authenticate.auth,
  userVerify.userVerify,
  portController.getPortNotFinished
); //Procurar Porto Pendente
router.get(
  "/user/port",
  authenticate.auth,
  userVerify.userVerify,
  portController.getPorts
); //Pegar os Portos disponiveis
router.post(
  "/user/port/startport",
  authenticate.auth,
  userVerify.userVerify,
  portController.onGoingPort
); //Começando um porto
...
router.get(
  ...
  authenticate.auth,
  userVerify.userVerify,
  questionsController.getPerguntas
); //Pegar as Perguntas
router.post(
  "/user/port/answerquestion",
  authenticate.auth,
  userVerify.userVerify,
  questionsController.respondendoPerguntas
